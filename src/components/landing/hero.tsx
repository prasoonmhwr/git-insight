                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div className="text-left space-y-8">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    ...
                                    <button onClick={() => setOpen(true)} className="px-8 py-4 rounded-lg border border-slate-700 text-slate-300 hover:border-slate-600 hover:text-slate-100 hover:bg-slate-800/30 transition-all duration-200 flex items-center justify-center">
                                        View Demo
                                    </button>
                                </div>
                ...
                <DialogContent className="max-w-3xl">
                    ...
                    <div className="aspect-w-16 aspect-h-9 w-full">
                        <iframe
                            width="100%"
                            height="315"
                            src="https://www.youtube.com/embed/qA77EDUKDBw?si=csOnHzqu-SwOtxkX"
                            title="YouTube Video"
                            frameBorder="0"
